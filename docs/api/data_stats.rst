...
As an example, we show how one can configure the full ``nequip.data.DataStatisticsManager`` to have behavior equivalent to using
``nequip.data.CommonDataStatisticsManager`` as follows::
