...
def test_state_restoration(fake_model_training_session, device):
    """
    ...
    atol = {"float32": 2e-4, "float64": 1e-8}[model_dtype]
    ...
    package_path = pathlib.Path(f"{tmpdir}/new_packaged_model.nequip.zip")
