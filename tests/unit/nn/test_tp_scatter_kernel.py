...
# NOTE: failing case
# 8x0e+8x2e+8x1o x 1x0e+1x1o+1x2e -> 24x0e+32x1o+16x1e+16x2o+32x2e
...
@pytest.mark.parametrize(
    "feature_irreps_in",
    # ["4x0e + 3x1o + 2x2e", "3x1e + 2x0o + 4x2o", "2x0e + 2x1o + 2x2e"],
    ["8x0e+8x2e+8x1o"],
)
@pytest.mark.parametrize("irreps_edge_attr", ["0e + 1o + 2e"])
@pytest.mark.parametrize(
    "irreps_mid",
    [
        "24x0e+32x1o+16x1e+16x2o+32x2e"
    ],  # ["0e + 1o + 2e", "1o + 2e + 0e", "2x0e + 2x1o + 2x2e"]
)
